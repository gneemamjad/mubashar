...
$(document).ready(function () {
    const $preloaderWrapper = $('.preloader-wapper');
    const $preloaderMain = $('.preloader-main');

    // نطر 3 ثواني بعد ما يجهز الـ DOM
    setTimeout(() => {
        $preloaderWrapper.addClass('loaded');

        $preloaderMain.fadeOut(300, function () {
            $(this).remove();
        });
    }, 3000);
});
