...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-end">
        <a href="{{route('admin.ads.createAd')}}" class="btn btn-sm btn-primary" style="margin: 10px;">
            <i class="ki-duotone ki-plus fs-2"></i>{{ __('ads.add') }}
        </a>
    </div>
    @endif
    <div class="card-header py-5 flex-wrap gap-2">
        ...
        <div class="flex gap-6">
            ...
            <div class="relative">
             ...
             <div class="relative">
                <label for="type-filter" class="block text-sm font-medium text-gray-700 mb-1">{{ __('admin.type') }}</label>
                <select class="select select-sm" id="type-filter" data-kt-user-table-filter="selectType" >
                    <option value="">{{ __('admin.all') }}</option>
                    <option value="1">{{ __('admin.real_estate') }}</option>
                    <option value="15">{{ __('admin.vehicles') }}</option>
                </select>
             </div>
             
             <div class="relative">
                <label for="category-filter" class="block text-sm font-medium text-gray-700 mb-1">{{ __('admin.category') }}</label>
                <select class="select select-sm" id="category-filter" data-kt-user-table-filter="selectCategory" multiple>
                    <option value="">{{ __('admin.all') }}</option>
             ...
             <div class="relative">
                <label for="paid-filter" class="block text-sm font-medium text-gray-700 mb-1">{{ __('admin.paid') }}</label>
                <select class="select select-sm" id="paid-filter" data-kt-user-table-filter="selectPaid" >
                    <option value="">{{ __('admin.all') }}</option>
                    <option value="1">{{ __('admin.paid') }}</option>
                    <option value="0">{{ __('admin.not_paid') }}</option>
                </select>
             </div>

            <div class="relative">
                <label for="active-filter" class="block text-sm font-medium text-gray-700 mb-1">{{ __('admin.active') }}</label>
                <select class="select select-sm" id="active-filter" data-kt-user-table-filter="selectActive" >
                    <option value="">{{ __('admin.all') }}</option>
            ...
            <div class="relative">
                ...
                <select class="select select-sm" id="status-filter" data-kt-user-table-filter="select" >
                    ...
                    <option value="2">{{ __('admin.not_approved') }}</option>
                </select>
             </div>
            @endif
    ...
    <div class="card-body">
        ...
        <div data-datatable="true" data-datatable-page-size="10">
            ...
            <div class="">
                <table style="text-align: center" class="table table-border fluid" data-datatable-table="true" id="ads_table">
                    <thead>
                        <tr>               
